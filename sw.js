const CACHE="one-answer-v5-stable";
const ASSETS=["./","./index.html","./share.html","./manifest.webmanifest","./icon-192.png","./icon-512.png","./kami-avatar.jpg","./dubu-avatar.jpg","./og-image.jpg"];
