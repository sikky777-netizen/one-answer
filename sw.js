const CACHE="one-answer-v11-stable";
const ASSETS=["./","./index.html","./share.html","./manifest.webmanifest","./icon-192.png","./icon-512.png","./install-icon-v11-192.png","./install-icon-v11-512.png","./dubu-avatar.jpg","./og-image.jpg"];
