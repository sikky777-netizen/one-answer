const CACHE="one-answer-v10-stable";
const ASSETS=["./","./index.html","./share.html","./manifest.webmanifest","./icon-192.png","./icon-512.png","./install-icon-v10-192.png","./install-icon-v10-512.png","./dubu-avatar.jpg","./og-image.jpg"];
