const CACHE="one-answer-v25-empty-ad";
const ASSETS=["./","./index.html","./share.html","./manifest.webmanifest","./icon-192.png","./icon-512.png","./install-icon-v13-192.png","./install-icon-v13-512.png","./dubu-avatar.jpg","./og-image.jpg"];
