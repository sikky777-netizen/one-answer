const CACHE="one-answer-v24-tv-install";
const ASSETS=["./","./index.html","./share.html","./manifest.webmanifest","./icon-192.png","./icon-512.png","./install-icon-v13-192.png","./install-icon-v13-512.png","./dubu-avatar.jpg","./og-image.jpg","./tv-install-320x80.png"];
